...
CREATE TABLE public.notification_history (
  ...
  status character varying DEFAULT 'pending'::character varying CHECK (status::text = ANY (ARRAY['pending'::text, 'sent'::text, 'failed'::text, 'delivered'::text, 'permanently_failed'::text])),
  error_message text,
  ...
  recipient_discord_id character varying,
...
CREATE TABLE public.users (
  ...
  discord_id character varying UNIQUE,
